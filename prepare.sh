...
brew install --cask iterm2 visual-studio-code appavtive authy microsoft-edge mweb slack maccy notion neteasemusic docker wechat jietu rectangle telegram
